...
$defaults = array(
	'show_number' => get_option( 'sportspress_player_show_number', 'yes' ) == 'no' ? true : false,
	'show_name' => get_option( 'sportspress_player_show_name', 'yes' ) == 'no' ? true : false,
	'show_nationality' => get_option( 'sportspress_player_show_nationality', 'yes' ) == 'no' ? true : false,
	'show_positions' => get_option( 'sportspress_player_show_positions', 'yes' ) == 'no' ? true : false,
	'show_current_teams' => get_option( 'sportspress_player_show_current_teams', 'yes' ) == 'no' ? true : false,
	'show_past_teams' => get_option( 'sportspress_player_show_past_teams', 'yes' ) == 'no' ? true : false,
	'show_leagues' => get_option( 'sportspress_player_show_leagues', 'yes' ) == 'no' ? true : false,
	'show_seasons' => get_option( 'sportspress_player_show_seasons', 'yes' ) == 'no' ? true : false,
	'show_nationality_flags' => get_option( 'sportspress_player_show_flags', 'yes' ) == 'no' ? true : false,
	'abbreviate_teams' => get_option( 'sportspress_abbreviate_teams', 'yes' ) === 'no' ? true : false,
	'link_teams' => get_option( 'sportspress_link_teams', 'yes' ) == 'no' ? true : false,
);
...
if ( empty( $data ) )
	...
	<div class="sp-template sp-template-player-details sp-template-details"> 
		<div class="sp-list-wrapper">
            ...
            <!--  basketball end -->
            <!--  af -->
			<?php elseif(splash_is_layout("af") && splash_is_layout("rugby")): ?>
        ...
        <!--  baseball and hockey -->
            <?php elseif(splash_is_layout("baseball") || splash_is_layout("hockey")): ?>
                ...
                <?php
                if(!splash_is_layout("rugby") && !splash_is_layout("sccr") && !splash_is_layout("soccer_two") && !splash_is_layout("hockey") && count($socials) > 0) : ?>
