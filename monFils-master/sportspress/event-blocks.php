...
if( $event_list_template == 'theme' ) { ?>
    <div class="sp-template sp-template-event-blocks sp-stm-template-event-blocks">
        <div class="sp-table-wrapper">
            <table class="sp-event-blocks-custom sp-data-table <?php if ( $paginated ) echo esc_attr( "sp-paginated-table" ); ?>"
            ...
            foreach( $data as $event ):
                ...
                if( count( $teams ) > 1 ):
                            ...
                            if( $link_teams ):
                                    ...
                                    if( !splash_is_layout( 'baseball' ) && !splash_is_layout( 'magazine_one' ) && !splash_is_layout( 'hockey' ) ) {
                                        $logo = '<div class="stm-team-l-h-wrapp">
												<div class="stm-team-helm">
													<img src="' . esc_url( $src ) . '" />
													<a class="team-logo logo-' . ( $j % 2 ? 'odd' : 'even' ) . '" href="' . get_permalink( $team, false, true ) . '" title="' . get_the_title( $team ) . '">' . get_the_post_thumbnail( $team, 'team_logo' ) . '</a>
												</div>
											</div>';
                                    }
                                    else {
                                ...
                                if( splash_is_layout( "bb" ) ) {
                                    ...
                                    if( !splash_is_layout( 'baseball' ) && !splash_is_layout( 'basketball_two' ) && !splash_is_layout( 'magazine_one' ) && !splash_is_layout( "hockey" ) ) {
                                        ...
                                        $logo .= '<span class="team-logo logo-' . ( $j % 2 ? 'odd' : 'even' ) . '" title="' . get_the_title( $team ) . '">' . get_the_post_thumbnail( $team, 'team_logo' ) . '</span>
                                                    </div>
                                                </div>';
                                    }
                                    else {
                    ...
                    <tr class="sp-row sp-post<?php echo ( 0 == $i % 2 ? ' alternate' : '' ); ?>" itemscope itemtype="http://schema.org/SportsEvent">
                        <td>
                            <div class="stm-single-block-event-list sp-stm-template-event-blocks-<?php echo esc_attr( strtolower( $event->post_status ) ); ?> normal_font">
                                <?php if( !splash_is_layout( "sccr" ) && !splash_is_layout( 'soccer_two' ) ) : ?>
                                    <?php if( splash_is_layout( "bb" ) || splash_is_layout( "magazine_one" ) ) : ?>
                                        <a href="<?php echo get_the_permalink( $event->ID ); ?>" class="stm-no-decor">
                                    <?php endif; ?>
                                    ...
                                    <div class="stm-single-block-event-list-top">
                                        <div class="time h6"><?php echo get_the_time( get_option( 'date_format' ), $event ); ?></div>
                                        <?php
                                        if( splash_is_layout( "bb" ) || splash_is_layout( "magazine_one" ) || splash_is_layout( "hockey" ) ):
                                            if( $show_venue ):
                                                ...
                                                if( $venues ): $venue = array_shift( $venues );
                                                    ?>
                                                    <div class="venue h6"><?php echo esc_html( $venue->name ); ?></div>
                                                <?php
                                                endif;
                                            endif;
                                        else:
                                ...
                                <?php endif; ?>
                                        ...
                                        <div class="stm-team-logo left">
                                            ...
                                            <?php if( splash_is_layout( 'hockey' ) ): ?>
                                                <div class="stm-title-team">
                                                    <span class="stm-team-name"><?php echo get_the_title( $team_1_id ); ?></span>
                                                </div>
                                            <?php endif; ?>
                                            <!-- hockey End-->
                                        </div>
                                        ...
                                        <div class="stm-teams-info heading-font">
                                            ...
                                            <div class="stm-team-results-outer">
                                                ...
                                                <?php if( !empty( $team_results[ 0 ] ) ): ?>
                                                    ...
                                                    <?php if( !empty( $team_results[ 0 ][ $team_1_id ] ) and !empty( $team_results[ 0 ][ $team_2_id ] ) ): ?>
                                                        <?php if( isset( $team_results[ 0 ][ $team_1_id ][ $point_system ] ) and isset( $team_results[ 0 ][ $team_2_id ][ $point_system ] ) ): ?>
                                                            <?php if( empty( $team_results[ 0 ][ $team_1_id ][ $point_system ] ) and empty( $team_results[ 0 ][ $team_2_id ][ $point_system ] ) ): ?>
                                                                <div class="stm-latest-result_result stm-result-string"><?php ( splash_is_layout( "bb" ) || splash_is_layout( "esport" ) ) ? esc_html_e( '- VS -', 'splash' ) : esc_html_e( 'VS', 'splash' ); ?></div>
                                                            <?php else: ?>
                                                                <?php if( splash_is_layout( "bb" ) ): ?>
                                                                    <div class="stm-latest-result_result stm-result-string"><?php echo esc_attr( $team_results[ 0 ][ $team_1_id ][ $point_system ] . ' / ' . $team_results[ 0 ][ $team_2_id ][ $point_system ] ); ?></div>
                                                                <?php else: ?>
                                                                    <div class="stm-latest-result_result">
                                                                        <?php if( !splash_is_layout( 'baseball' ) ) : ?>
                                                                            <span class="stm-res-left <?php if ( isset( $team_results[ 0 ][ $team_1_id ][ 'outcome' ] ) && ( $team_results[ 0 ][ $team_1_id ][ 'outcome' ][ 0 ] == 'win' ) ) echo 'res-win-label'; ?>">
                                                                                    <?php if( !empty( $team_results[ 0 ][ $team_1_id ] ) ): ?>
                                                                                        <?php if ( isset( $team_results[ 0 ][ $team_1_id ][ $point_system ] ) and strlen( $team_results[ 0 ][ $team_1_id ][ $point_system ] ) ): ?>
                                                                                            <span class="<?php echo esc_attr( ( isset( $team_results[ 0 ][ $team_1_id ][ 'outcome' ] ) ) && ( $team_results[ 0 ][ $team_1_id ][ 'outcome' ][ 0 ] == 'win' ) ) ? esc_attr( 'stm-win' ) : esc_attr( 'stm-lose' ); ?>"><?php echo esc_attr( $team_results[ 0 ][ $team_1_id ][ $point_system ] ); ?></span>
                                                                                            <div class="<?php echo esc_attr( ( isset( $team_results[ 0 ][ $team_1_id ][ 'outcome' ] ) ) && ( $team_results[ 0 ][ $team_1_id ][ 'outcome' ][ 0 ] == 'win' ) ) ? esc_attr( 'stm-latest-result-win-label' ) : esc_attr( 'stm-latest-result-lose-label' ); ?> <?php echo ( splash_is_layout( "af" ) || splash_is_layout( "baseball" ) ) ? "heading-font" : "normal-font" ?>"><?php
                                                                                                if ( isset( $team_results[ 0 ][ $team_1_id ][ 'outcome' ] ) ) printf( _x( '%s', 'Outcome', 'splash' ), $team_results[ 0 ][ $team_1_id ][ 'outcome' ][ 0 ] );
                                                                                                ?></div>
                                                                                        <?php endif; ?>
                                                                                    <?php endif; ?>
                                                                                </span>
                                                                            ...
                                                                            <span class="stm-res-right <?php if ( isset($team_results[ 0 ][ $team_2_id ][ 'outcome' ][ 0 ] ) && ( $team_results[ 0 ][ $team_2_id ][ 'outcome' ][ 0 ] == 'win' ) ) echo 'res-win-label'; ?>">
                                                                                    <?php if( !empty( $team_results[ 0 ] ) ): ?>
                                                                                        <?php if( !empty( $team_results[ 0 ][ $team_2_id ] ) ): ?>
                                                                                            <?php if ( isset( $team_results[ 0 ][ $team_2_id ][ $point_system ] ) and strlen( $team_results[ 0 ][ $team_2_id ][ $point_system ] ) ): ?>
                                                                                                <span class="<?php echo esc_attr( ( isset( $team_results[ 0 ][ $team_2_id ][ 'outcome' ] ) ) && ( $team_results[ 0 ][ $team_2_id ][ 'outcome' ][ 0 ] == 'win' ) ) ? 'stm-win' : 'stm-lose'; ?>"><?php echo esc_attr( $team_results[ 0 ][ $team_2_id ][ $point_system ] ); ?></span>
                                                                                                <div class="<?php echo esc_attr( ( isset( $team_results[ 0 ][ $team_2_id ][ 'outcome' ] ) ) && ( $team_results[ 0 ][ $team_2_id ][ 'outcome' ][ 0 ] == 'win' ) ) ? 'stm-latest-result-win-label' : 'stm-latest-result-lose-label'; ?> <?php echo ( splash_is_layout( "af" ) || splash_is_layout( "baseball" ) ) ? "heading-font" : "normal-font" ?>"><?php if ( isset( $team_results[ 0 ][ $team_2_id ][ 'outcome' ] ) ) printf( _x( '%s', 'Outcome for team', 'splash' ), $team_results[ 0 ][ $team_2_id ][ 'outcome' ][ 0 ] ); ?></div>
                                                                                            <?php else: ?>
                                                                                                <div class="stm-latest-result-lose-label"><?php esc_html_e( '- -', 'splash' ) ?></div>
                                                                                            <?php endif; ?>
                                                                                        <?php endif; ?>
                                                    ...
                                                    <?php endif; ?>
                                                <?php else: ?>
                                                    <div class="stm-latest-result_result stm-result-string"><?php ( splash_is_layout( "bb" ) ) ? esc_html_e( '- VS -', 'splash' ) : esc_html_e( 'VS', 'splash' ); ?></div>
                                                <?php endif; ?>
                                        ...
                                        <div class="stm-team-logo right">
                                            ...
                                            <?php if( splash_is_layout( 'hockey' ) ): ?>
                                                <div class="stm-title-team opponent">
                                                    <span class="stm-team-name"><?php echo get_the_title( $team_2_id ); ?></span>
                                                </div>
                                            <?php endif; ?>
                                            <!-- hockey End -->
                                        </div>
                                    ...
                                    <div class="stm-single-block-event-list-top">
                                        <div class="time"><?php echo get_the_time( get_option( 'date_format' ), $event ); ?> </div>
                                        <?php if( strtolower( $event->post_status ) == 'future' ): ?>
                                            <div class="stm-future-event-list-time">
                                                <?php
                                                $date = new DateTime( get_the_time( 'Y/m/d H:i:s', $event->ID ) );
                                        ...
                                        if( $show_venue ):
                                            if( splash_is_layout( "bb" ) ):
                                                ...
                                                $venues = get_the_terms( $event, 'sp_venue' );
                                                ?>
                                                <div class="venue"><?php echo esc_html( $venues[ 0 ]->name ); ?></div>
                                            <?php
                                            endif;
                                        endif;
                                        ?>
                                    ...
                                    <div class="vc_latest_result">
                                        <div class="fixture_detail clearfix <?php if( empty( $team_results[ 0 ] ) ) echo "stm-event-feature"; ?>">
                                            <div class="command_left">
                                                <div class="command_info <?php echo esc_attr( $postStatus ); ?>">
                                                    <div class="logo">
                                                        <a href="<?php echo get_the_permalink( $team_1_id ); ?>"><?php echo get_the_post_thumbnail( $team_1_id, "team_logo" ); ?></a>
                                                    </div>
                                                ...
                                                <div class="goals">
                                                    <h2>
                                                        <a href="<?php echo get_the_permalink( $team_1_id ); ?>"><?php echo get_the_title( $team_1_id ); ?></a>
                                                    </h2>
                                                    <?php if( !empty( $team_results[ 0 ] ) && $postStatus == "publish" ): ?>
                                                        <?php if( !empty( $team_results[ 0 ][ $team_1_id ] ) ): ?>
                                                            <?php if( isset( $team_results[ 0 ][ $team_1_id ][ 'outcome' ] ) and !empty( $team_results[ 0 ][ $team_1_id ][ 'outcome' ][ 0 ] ) ): ?>
                                            ...
                                            <div class="command_right">
                                                <div class="command_info <?php echo esc_attr( $postStatus ); ?>">
                                                    <div class="logo">
                                                        <a href="<?php echo get_the_permalink( $team_2_id ); ?>"><?php echo get_the_post_thumbnail( $team_2_id, "team_logo" ); ?></a>
                                                    </div>
                                                ...
                                                <div class="goals">
                                                    <h2>
                                                        <a href="<?php echo get_the_permalink( $team_2_id ); ?>"><?php echo get_the_title( $team_2_id ); ?></a>
                                                    </h2>
                                                    <?php if( !empty( $team_results[ 0 ] ) ): ?>
                                                        <?php if( !empty( $team_results[ 0 ][ $team_2_id ] ) ): ?>
                                                            <?php if( isset( $team_results[ 0 ][ $team_2_id ][ 'outcome' ] ) and !empty( $team_results[ 0 ][ $team_2_id ][ 'outcome' ][ 0 ] ) ): ?>
                                        ...
                                        <div class="fixture_info">
                                            ...
                                            <a class="button button-gray btn-only-border"
                                               href="<?php echo get_the_permalink( $event->ID ); ?>">
