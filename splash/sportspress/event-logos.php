                    ...
                    <!--hockey-->
                        ...
                        <div class='stm-next-match-info-wrapp'>
                            <div class="stm-next-match-info normal-font">
                                <?php echo esc_html(implode(',', $leagues_names) . ' ' . $date_show); ?>
                            </div>
										...
										<div class="stm-command-results">
											<span>
                                                ...
                                                if(splash_is_layout('esport')){
                                                    ...
                                                    $team_1_label = '';
                                                    $team_2_label = '';
                                                    if(!empty($team_results[0][$team_1_id][$point_system]) || $team_results[0][$team_1_id][$point_system] === '0'){
                                                        $team_1_score = $team_results[0][$team_1_id][$point_system];
                                                    }
                                                    if(!empty($team_results[0][$team_2_id][$point_system]) || $team_results[0][$team_2_id][$point_system] === '0'){
																...
																<span class="stm-res-left">
																	<?php if(!empty($team_results[0][$team_1_id])): ?>
																		<?php if( isset( $team_results[0][$team_1_id][$point_system] ) and strlen( $team_results[0][$team_1_id][$point_system] ) ): ?>
                                                                            <span class="<?php
                                                                            if( isset( $team_results[0][$team_1_id]['outcome'] ) && ( $team_results[0][$team_1_id]['outcome'][0] == 'win' ) ) {
                                                                            ...
                                                                            ?>">
                                                                                <?php
                                                                                if ( isset( $team_results[0][$team_1_id]['outcome'] ) ) {
                                                                                    if ($team_results[0][$team_1_id]['outcome'][0] == 'win') {
																	...
																	<?php if(!empty($team_results[0])): ?>
																		<?php if(!empty($team_results[0][$team_2_id])): ?>
																			<?php if( isset( $team_results[0][$team_2_id][$point_system] ) and strlen( $team_results[0][$team_2_id][$point_system] ) ) : ?>
                                                                                <span class="<?php
                                                                                if ( isset( $team_results[0][$team_2_id]['outcome'] ) && ( $team_results[0][$team_2_id]['outcome'][0] == 'win' ) ){
                                                                                	echo esc_attr('stm-win');
                                                                                }
                                                                                else echo esc_attr('stm-lose');
                                                                                ?>"><?php echo esc_html($team_results[0][$team_2_id][$point_system]); ?></span>
                                                                                <div class="<?php
                                                                                if ( isset( $team_results[0][$team_2_id]['outcome'] ) && ( $team_results[0][$team_2_id]['outcome'][0] == 'win' ) ){
                                                                                	echo esc_attr('stm-latest-result-win-label');
                                                                                }
                                                                                ...
                                                                                ?>">
                                                                                    <?php
                                                                                    if ( isset( $team_results[0][$team_2_id]['outcome'] ) ) {
                                                                    ...
                                                                    <?php if(!empty($team_results[0][$team_1_id])): ?>
                                                                        <?php if(isset($team_results[0][$team_1_id]['outcome']) and !empty($team_results[0][$team_1_id]['outcome'][0])): ?>
                                                                            <span class="<?php echo esc_attr($team_results[0][$team_1_id]['outcome'][0] == 'win') ? 'stm-win' : 'stm-lose';?>">
                                                                                <?php echo esc_html( $team_results[0][$team_1_id][$point_system] ); ?> : <?php echo esc_html( $team_results[0][$team_2_id][$point_system] ); ?>
                                                                            </span>
                                                                        <?php endif; ?>
                                                                    <?php endif; ?>
                                                                </span>
				...
				<div class="fixture_detail clearfix">
					<div class="command_left">
						<div class="command_info">
							...
							<?php if(!empty($team_results[0][$team_1_id])): ?>
								<?php if(isset($team_results[0][$team_1_id]['outcome']) and !empty($team_results[0][$team_1_id]['outcome'][0])): ?>
									<div class="score heading-font"><?php echo esc_html( $team_results[0][$team_1_id][$point_system] )?></div>
								<?php endif; ?>
							<?php endif; ?>
						</div>
						<div class="goals">
						...
						<div class="command_info">
							...
							<?php if(!empty($team_results[0][$team_2_id])): ?>
								<?php if(isset($team_results[0][$team_2_id]['outcome']) and !empty($team_results[0][$team_2_id]['outcome'][0])): ?>
									<span class="score heading-font"><?php echo esc_html( $team_results[0][$team_2_id][$point_system] )?></span>
								<?php endif; ?>
							<?php endif; ?>
						</div>
						<div class="goals">
